module.exports = (ordersCollection, decodeFbToken, verifyAdmin, verifySeller) => {
    const express = require('express');
    const router = express.Router();


    // api for seller payment history page
    router.get('/sellers/payment-history',decodeFbToken, verifySeller, async (req, res) => {
    ...
    router.get('/admin-dashboard', decodeFbToken, verifyAdmin, async (req, res) => {
